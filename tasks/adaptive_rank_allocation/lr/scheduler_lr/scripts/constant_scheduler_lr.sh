...
for rank_allocation_lr in 0.002 0.01 0.02; do
  export WANDB_PROJECT="adalora_constant_scheduler" #project folder name
  export CUDA_VISIBLE_DEVICES=0  # Assign GPU 0
  export WANDB_NOTES="rank_allocation_weights initialized to random, same scheduling, rank_max  is 30, average rank is 20, rank_min is 5. discrete rank on the last epoch. constant scheduler for lr"
