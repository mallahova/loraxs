...
for seed in 0 1 2; do
  ...
  python scripts/run_glue_adaptive.py --target_task cola --wandb_disabled False  --seed $seed --rank_allocation_learning_rate 0.01 --epoch 51 --rank_min 5 --memory_size 56400&
done
