...
for rank_allocation_learning_rate in 0.002 0.005 0.01; do
  ...
  python scripts/run_glue_adaptive.py --target_task cola --wandb_disabled False --seed 0 --rank_allocation_learning_rate $rank_allocation_learning_rate --rank_max 50 --rank_average 20 --epoch 51 &
done
