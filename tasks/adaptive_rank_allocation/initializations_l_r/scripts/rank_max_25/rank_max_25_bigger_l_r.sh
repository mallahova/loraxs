...
for rank_allocation_learning_rate in 0.02 0.05 0.1; do
  ...
  python scripts/run_glue_adaptive.py --target_task cola --wandb_disabled False --seed 3 --rank_allocation_learning_rate $rank_allocation_learning_rate --epoch 51 --rank_min 5 --rank_average 20 &
done
