...
for rank_allocation_learning_rate in 0.01 0.002 0.02; do
  export WANDB_PROJECT="adaptive_rank_allocation_l_r"
  export CUDA_VISIBLE_DEVICES=0  # Assign GPU 0
  export WANDB_NOTES="rank_allocation_weights initialized to quadratic, same scheduling, discrete rank on the last epoch, rank_min is 5" # run description
