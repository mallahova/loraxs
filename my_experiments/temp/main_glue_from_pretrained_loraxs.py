...
def main():
    ...
    training_args.output_dir = f"{training_args.output_dir}/{model_args.model_name_or_path}/{data_args.task_name}/pretrained_LoRA_init_{reconstr_type}_rank_{peft_config_dict[adapter_name].r}_lr_{training_args.learning_rate}_clsLR_{model_args.cls_lr}_seed_{training_args.seed}/output_{now}"
